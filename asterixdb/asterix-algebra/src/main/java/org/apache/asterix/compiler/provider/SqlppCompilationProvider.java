...
public class SqlppCompilationProvider implements ILangCompilationProvider {
    ...
    public Set<String> getCompilerOptions() {
        return new HashSet<>(Set.of(CompilerProperties.COMPILER_JOINMEMORY_KEY,
                ...
                CompilerProperties.COMPILER_PLAQUE_ENABLED_KEY,
                CompilerProperties.COMPILER_PLAQUE_PROPAGATION_KEY,
                CompilerProperties.COMPILER_PLAQUE_PROPAGATION_INTERVAL_KEY,
                CompilerProperties.COMPILER_PLAQUE_PUSH_THROUGH_JOIN_KEY,
                CompilerProperties.COMPILER_PLAQUE_EAGER_BATCH_SIZE_KEY,
